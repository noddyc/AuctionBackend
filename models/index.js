/*
    this is to initialize relationships among different tables in the database
*/
...
// this is the function of generating pseudo data in the database of user table
function generate(){
    ...
    for(let i = 0; i < 100; i++){
        ...
        let product_description =  uniqueNamesGenerator({
            dictionaries: [adjectives, colors, adjectives, colors, adjectives, colors, 
                adjectives, colors, adjectives, animals], 
            length: 10
          }); 
